...
export declare type AccountType = "CHECKING" | "SAVINGS" | "CREDITCARD" | "LOAN" | "KIWISAVER" | "INVESTMENT" | "TERMDEPOSIT" | "FOREIGN" | "TAX" | "REWARDS" | "WALLET";
export declare type AccountAttribute = "PAYMENT_TO" | "PAYMENT_FROM" | "TRANSFER_TO" | "TRANSFER_FROM" | "TRANSACTIONS";
...
export declare type AccountLoanDetails = {
    /**
    ...
    repayment?: {
         ...
         */
        frequency?: "WEEKLY" | "FORTNIGHTLY" | "MONTHLY" | "QUARTERLY" | "BIANNUALLY" | "ANNUALLY";
        /**
...
export declare type AccountRefreshState = {
    /**
