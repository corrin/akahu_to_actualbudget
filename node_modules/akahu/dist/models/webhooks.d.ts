...
export declare type WebhookType = "TOKEN" | "ACCOUNT" | "TRANSACTION" | "TRANSFER" | "PAYMENT";
...
export declare type WebhookPayload = CancelledPayload | TokenPayload | AccountPayload | TransactionPayload | TransferPayload | PaymentPayload;
/**
