...
export declare type IdentityVerifyNameQuery = {
    /**
...
export declare type AccountHolderNameVerificationSource = {
    type: "HOLDER_NAME";
 ...
 */
export declare type PartyNameVerificationSource = {
    type: "PARTY_NAME";
    match_result: "MATCH" | "PARTIAL_MATCH";
...
export declare type IdentityVerifyNameResult = {
    sources: (AccountHolderNameVerificationSource | PartyNameVerificationSource)[];
};
