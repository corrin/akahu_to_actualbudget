...
class AkahuClient {
    constructor(config) {
        const _a = Object.assign({ apiVersion: "v1", protocol: "https", host: "api.akahu.io" }, config), { appToken, appSecret, apiVersion, protocol, host, port } = _a, axiosOptions = __rest(_a, ["appToken", "appSecret", "apiVersion", "protocol", "host", "port"]);
        ...
        this.axios = axios.create(Object.assign(Object.assign({}, filteredAxiosOptions), { baseURL: buildUrl({ protocol, host, port, path: apiVersion }), headers: Object.assign(Object.assign({}, filteredAxiosOptions.headers), akahuHeaders) }));
    ...
    _makeIdempotent(config, options) {
        ...
        if (((_a = config.method) === null || _a === void 0 ? void 0 : _a.toUpperCase()) === "POST") {
            return Object.assign(Object.assign({}, config), { headers: Object.assign(Object.assign({}, config.headers), { "Idempotency-Key": (_b = options.idempotencyKey) !== null && _b !== void 0 ? _b : v4() }) });
        }
        return config;
    }
    ...
    _apiCall({ path, method = "GET", query, data, auth, options = {}, }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _d = response.data, { success, cursor } = _d, payload = __rest(_d, ["success", "cursor"]);
